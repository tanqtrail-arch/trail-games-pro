...
export default function Footer() {
  return (
    <footer className="bg-trail-dark text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[9px] font-medium text-gray-400 leading-tight tracking-wider">
                  探究教室
                </span>
              </div>
            </div>
          ...
          {/* Links */}
          <div>
            <h3 className="text-sm font-bold text-white mb-4">リンク</h3>
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-gray-700/50 flex items-center justify-center text-gray-400 hover:bg-trail-primary hover:text-white transition-all"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="mt-10 pt-6 border-t border-gray-700/50 text-center">
          <p className="text-sm text-gray-500">
            &copy; 2026 探究教室 TRAIL. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
