...
const completionByCategory = [
  { category: "理科", rate: 72, color: "#40916C" },
  { category: "社会", rate: 82, color: "#DDA15E" },
  { category: "算数", rate: 48, color: "#577590" },
            ...
            >
              ...
              <div>
                ...
                <div className="w-full bg-slate-100 rounded-full h-2">
                  <div
                    className="bg-gradient-to-r from-trail-primary to-trail-secondary h-full rounded-full"
